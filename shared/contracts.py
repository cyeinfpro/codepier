...
class ShellExec(Project):
    ...
    env: dict[str, str] = Field(default_factory=dict, description="Optional environment overrides. Prefer existing local credentials; values are hidden from audit argument summaries but commands/output may disclose them.")
...
PROCESS_TOOLS = {"tasks_run", "shell_exec"}
