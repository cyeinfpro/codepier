...
async function agentInstallSetup(device=null){
  ...
  form.onsubmit=async event=>{
    ...
    const options={hub_url:form.elements.hub_url.value.trim(),platform,allow_root};
