...
function chatProjectButtons(project){return `<button class="btn small" data-native-launch="pi" data-project="${esc(project)}">Pi</button><button class="btn small" data-native-launch="codex" data-project="${esc(project)}">Codex</button><button class="btn small" data-native-launch="claude" data-project="${esc(project)}">Claude</button>`;}
