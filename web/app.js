...
const nav=[['native','terminal','CLI 会话','11'],['overview','dashboard','控制总览','01'],['devices','device','设备节点','02'],['projects','folder','项目映射','03'],['vps','cloud','VPS 管理','13'],['workbench','code','远程工作台','04'],['workflows','history','开发任务','05'],['audit','audit','操作审计','06'],['connect','plug','MCP 接入','07'],['diagnostics','activity','运行诊断','08'],['integrations','network','开发工具','12'],['artifacts','download','产物交付','09'],['settings','settings','系统设置','10']];
...
function renderShell(){
  ...
  const groups=[['工作区',['overview','devices','projects','vps']],['开发',['native','workbench','integrations','workflows','artifacts','audit']],['系统',['connect','diagnostics','settings']]];
